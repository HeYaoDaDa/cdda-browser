...
enum class CddaType(
  ...
  SKILL_DISPLAY_TYPE(setOf(JsonType.SKILL_DISPLAY_TYPE), SkillDisplayType::class),
  SKILL(setOf(JsonType.SKILL), Skill::class),
  MARTIAL_ART(setOf(JsonType.MARTIAL_ART), MartialArt::class),
